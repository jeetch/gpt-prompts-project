...
const Footer: FC<FooterProps> = ({}) => {
  return (
    <div className="bg-white text-slate-500 w-full">
      <div className="flex  flex-col items-center justify-between gap-4 border-t border-t-slate-200 py-5 md:h-10 md:flex-row md:py-0">
